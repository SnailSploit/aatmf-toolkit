...
TACTIC_TO_PLAYBOOK_LAYER: dict[str, int] = {
    "T1": 1, "T2": 1, "T3": 2, "T4": 2, "T5": 5,
    "T6": 0, "T7": 4, "T8": 3, "T9": 1, "T10": 0,
    "T11": 5, "T12": 1, "T13": 0, "T14": 0, "T15": 3,
    "T16": 5, "T17": 5, "T18": 1, "T19": 2, "T20": 5,
}

# ── Executable vs Simulation-Only Types ──────────────────────

EXECUTABLE_TYPES: set[str] = {
    "injection", "encoding", "single_turn", "multi_turn",
    "output_exploit", "deception", "mcp_exploit", "evasion",
}

SIMULATION_TYPES: set[str] = {
    "api_exploit", "training_poison", "multimodal", "supply_chain",
    "agentic", "rag_injection", "model_theft", "infra", "human_workflow",
    "a2a_attack", "persistence", "orchestration",
}
